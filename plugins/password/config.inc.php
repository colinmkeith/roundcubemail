...
// $config['password_db_dsn'] = 'mysql://roundcube:p0tt%3D4g3@mysql/roundcubemail';
...
$config['password_query'] = 'UPDATE hosting.pop3 SET password=%p WHERE pop3=%l AND password=%o AND domain=%d LIMIT 1';
